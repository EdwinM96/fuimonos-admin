                                ...
                                <div class="main-card mb-3 card">
                                    ...
                                    <form method="POST" action="${pageContext.request.contextPath}/submenu/crear">
                                        <div class="row mt-4 mb-5">
                                            ...
                                            <div class="form-label-group">
                                                <label for="menuCobrado">Menu cobrado:</label>
                                                <input type="checkbox" id="menuCobrado" class="form-control" name="menucobrado" onclick="changeReadOnly(this)" >
                                            </div>
                                            <div class="col-lg-1"></div> 
                                            <div class="col-sm-9 col-md-7 col-lg-4 col-11 mx-auto">
                                                <div class="form-label-group mt-2">
                                                    <label for="cobrarAPartir">Cobrar a partir de: <font color="red">*</font></label>
                                            ...
                                            <div class="col-sm-9 col-md-7 col-lg-4 col-11 mx-auto">
                                                <div class="form-label-group mt-2">
                                                    ...
                                                    <input type="number" id="minimo" class="form-control" value="0" placeholder="Titulo" name="maximoopciones" readonly required>
                                                </div>
                                                <div class="form-label-group mt-2">
                                                    <label for="maximo">Máximo de Opciones a escoger: <font color="red">*</font></label>
                                                    <input type="number" id="maximo" class="form-control" value="0" placeholder="Titulo" name="maximoopciones" readonly required>
                                                </div>
                                            </div>
                                        </div>
