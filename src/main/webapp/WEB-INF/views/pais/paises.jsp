                        ...
                        <div class="main-card mb-3 card">
                            <div class="card-header" style="font-weight:bold;font-size: 16px;">
                                ...
                                <div class="btn-actions-pane-right">
                                    <button type="button" class="btn-success btn" data-toggle="modal" data-target="#agregarPaisModal">Agregar País</button>
                                </div>
                            </div>
...
<div class="modal fade" id="agregarPaisModal" tabindex="-1" role="dialog" aria-labelledby="modalLabelTitle" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="modalLabelTitle">Agregar País</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <form:form method="POST" action="paises" modelAttribute="paisModel">
                    <div class="row mt-4 mb-4 ml-4">
                        <div class="form-label-group">
                            <label>Nombre del país: <span style="color:red">*</span></label>
                            <form:input path="nombre_pais" cssClass="form-control"/>
                        </div>
                    </div>
