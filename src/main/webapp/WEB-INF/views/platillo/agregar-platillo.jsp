                                    ...
                                    <div class="row mt-4 mb-5">
                                        ...
                                        <div class="col-sm-9 col-md-7 col-lg-4 col-11 mx-auto">
                                            <div class="form-label-group mt-2">
                                                ...
                                                <input type="number" id="precio" class="form-control" step="0.01" placeholder="Precio"  name="precioBase" required/>
                                            </div>
                                            <div class="form-label-group mt-2">
                                                <label for="descripcion">Descripción: <font color="red">*</font></label>
                                                <textarea id="descripcion" class="form-control"  placeholder="Descripción"  name="descripcion" required></textarea>
                                            </div>
                                        </div>
