            ...
            <div class="app-container app-theme-white body-tabs-shadow fixed-sidebar fixed-header">
                                        ...
                                        <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                            ...
                                            <tbody>
                                                ...
                                                <td class="justify-content-end">
                                                    <a>
                                                        <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#deleteRestauranteModal">&times;</button>
                                                    </a>
                                                </td>
                                                    </tr>
                                            </c:forEach>
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <div class="text-center" id="nombreRestauranteModal" style="font-weight: bold"></div>
                            </div>
                ...
                <script type="text/javascript">
                    function llenarModalEliminar(id,nombreRestaurante){
                        document.getElementById("modalDeleteLink").href = "${pageContext.request.contextPath}/restaurante?id="+id;
