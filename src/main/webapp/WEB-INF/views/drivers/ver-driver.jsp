<%-- 
    Document   : ver-driver
    Created on : 2/08/2020, 10:51:52 AM
    Author     : HP PC
--%>
                            ...
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">
                                        Agregando&nbsp;<strong>Driver</strong>&nbsp;&nbsp;&nbsp;<a href="${pageContext.request.contextPath}/driver/editar?id=${driver.driverId}"><i class="far fa-edit fa-lg"></i></a>
                                    </div>
                                    <div class="row mt-4 mb-5">
                                        ...
                                        <div class="col-sm-9 col-md-7 col-lg-4 col-11 mx-auto">
                                            <div class="form-label-group">
                                                ...
                                                <div class="form-control" id ="nombre">${driver.nombreDriver}</div>
                                            </div>
                                        </div>       
                                        <div class="col-sm-9 col-md-7 col-lg-4 col-11 mx-auto">
                                            <div class="form-label-group">
                                                <label for="nombreDeUsuario">Nombre de usuario:</label>
                                                <div class="form-control" id="nombreDeUsuario">${driver.username}</div>
                                            </div>
                                        </div>  
                                        <div class="col-sm-9 col-md-7 col-lg-4 col-11 mx-auto">
                                            <div class="form-label-group">
                                                <label for="fechaCreado">Fecha creado:</label>
                                                <div class="form-control" id="fechaCreado"><fmt:formatDate value="${driver.fechaCreado}" pattern="dd-MM-yyyy " /></div>
                                            </div>
                                        </div> 
                                    </div>
                                    <div class="text-center mb-5 mt-3">
                                        <a href="${pageContext.request.contextPath}/driver/cambiarHabilitado?id=${driver.driverId}">
                                            <button type="button" class="btn ${driver.habilitado?"btn-danger":"btn-success"} btn-lg" style="padding-top:10px;padding-bottom:10px;padding-left:30px;padding-right:30px;font-size: 18px; margin-left:10px">
                                                ${driver.habilitado?"Inhabilitar":"Habilitar"}
                                            </button>
                                        </a>
                                    </div>
                                </div>
